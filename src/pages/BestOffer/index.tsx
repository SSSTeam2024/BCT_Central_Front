...
const BestOffer = () => {
  document.title = "Why Choose Us | Coach Hire Network";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumb title="Why Choose Us" pageTitle="Web Site Settings" />
          <Card>
                    ...
                    <Row>
                          ...
                          <div className="vstack gap-2">
                            ...
                            >
                              ...
                              <input
                                ...
                                accept="image/*"
                                onChange={(e) =>
                                  handleFileUpload(e, value, "image")
                                }
                      ...
                      <Col>
                        <Card className="border-0">
                          <Card.Body>
                            <Tab.Container
                              defaultActiveKey={value.tabs[0]?.title}
                            >
                              <Nav
                                as="ul"
                                variant="tabs"
